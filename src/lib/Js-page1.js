...
function newCard(evento) {
  ...
  divForCard.innerHTML = `
    ...
    <div class="card-body">
      ...
      <a href="./details.html" onclick="detalleCard(${evento.id})" class="btn btn-primary">Go somewhere</a>
    </div>
  </div>
    `;
...
tarjetasHome();
console.log(newCard(ArrayData.eventos[1]));
